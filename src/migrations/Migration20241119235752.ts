...
export class Migration20241119235752 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "user" add column "auth_provider" varchar(255) not null default 'local', add column "picture" varchar(255) null;`);
  ...
  override async down(): Promise<void> {
    this.addSql(`alter table "user" drop column "auth_provider", drop column "picture";`);
